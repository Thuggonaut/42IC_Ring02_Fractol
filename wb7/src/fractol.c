...
int	main(int argc, char **argv)
{
	...
	if ((argc == 2 && !ft_strncmp(argv[1], "mandelbrot", ft_strlen("mandelbrot") + 1))
		|| (argc == 2 && !ft_strncmp(argv[1], "mandelbox", ft_strlen("mandelbox") + 1))
		|| (argc == 4 &&!ft_strncmp(argv[1], "julia", ft_strlen("julia") +  1))) //TODO BONUS FRACTAL //If the ft_strncmp function returns 0 (the strings are equal), the ! operator negates the result and will convert it to 1, which evaluates to true
	{
